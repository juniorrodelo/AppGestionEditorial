    ...
    <div class="jumbotron">
        ...
        <div class="form-group">
         ...
         <asp:DropDownList onChange="javascript:mostrarAtributos(this.value);" ID="type" runat="server" class="form-control" >
             ...
             <div class="form-group">
                <label class="control-label" >No. Paginas</label>     
            ...
            <div class="form-group">
                <label class="control-label" >Copias Disponibles(cantidad)</label>
                 <asp:TextBox ID="txtCantidad" runat="server" class="form-control"  ></asp:TextBox>
             </div>

        <!-- Libros -->
            <div class="form-group oculto" id="nCapitulos" >
                <label class="control-label" >N° De Capitulos</label>
                 <asp:TextBox ID="txtnCapitulos"  runat="server" class="form-control" ></asp:TextBox>
                <span class="help-block with-errors"></span>
             </div>

            <div class="form-group oculto" id="nTomos">
                <label class="control-label" >N° De Tomos</label>
        ...
        <!-- REVISTAS -->
            <div class="form-group oculto" id="nVolumenes">
                <label class="control-label" >N° De volúmenes</label>
                 <asp:TextBox ID="txtVolumenes" runat="server" class="form-control" ></asp:TextBox>
                <span class="help-block with-errors"></span>
             </div>

            <div class="form-group oculto" id="nArticulos">
                <label class="control-label" >N° De Articulos</label>
